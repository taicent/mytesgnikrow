...
public:
	...
	virtual void ApplyOriginalSize(IntImage& original,const CString filename, bool isExp) ;
	virtual void ApplyOriginalSizeForInputBoosting(const char* filename,int& pointer) const;
