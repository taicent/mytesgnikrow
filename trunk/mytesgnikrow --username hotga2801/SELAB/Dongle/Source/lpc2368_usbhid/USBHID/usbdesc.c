...
const BYTE HID_ReportDescriptor[] = {
  ...
  HID_Collection(HID_Application),
    ...
    HID_LogicalMin(0),
    HID_LogicalMax(255),
    HID_ReportCount(16),  // 16 times 
    HID_ReportSize(8),    //  8 bit   
    HID_Input(HID_Data | HID_Variable | HID_Absolute),
   /*
    ...
    HID_ReportSize(8),    //  8 bit   
    HID_Input(HID_Data | HID_Variable | HID_Absolute),
    HID_UsagePage(HID_USAGE_PAGE_DEV_CONTROLS),  LCD Line 2 
    HID_Usage(0),
    HID_LogicalMin(0),
    HID_LogicalMax(255),
    HID_ReportCount(16),  // 16 times 
	...
	HID_UsagePage(HID_USAGE_PAGE_DEV_CONTROLS), /* LCD Line 1 */
    HID_Usage(0),
    HID_LogicalMin(0),
    HID_LogicalMax(255),
    HID_ReportCount(16),  /* 16 times */
