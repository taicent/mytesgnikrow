...
public class svm_train
{
    ...
    {
        get { return cross_validation; }
        set { cross_validation = value; }
    }
    public int Nr_fold
    {
        get { return nr_fold; }
	...
	private void  run(System.String[] argv)
	{
		...
		{
			do_cross_validation(svm_train.MSE, 0);
		}
		else
		{
	...
	public void  parse_command_line(System.String[] argv)
	{
		int i;
		...
		for (i = 0; i < argv.Length; i++)
		{
			...
			switch (argv[i - 1][1])
			{
				...
				case 'v': 
					...
					if (nr_fold < 1)
					{
						System.Console.Error.Write("n-fold cross validation: n must >= 1\n");
						exit_with_help();
					}
					break;
