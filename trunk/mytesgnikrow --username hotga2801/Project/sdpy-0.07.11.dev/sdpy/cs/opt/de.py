...
Modified a little bit by Minh-Tri Pham to work with scipy 0.6.0
...
class DiffEvolver:
    ...
    def bin_crossover(self, oldgene, newgene):
        mask = rand(self.ndim) < self.crossover_rate
    ...
    def select_samples(self, candidate, nsamples):
        ...
        return permutation(possibilities)[:nsamples]
    ...
    def get_trial(self, candidate):
        ...
        self.refine(trial) # added by Minh-Tri Pham
    ...
    def refine(self,trial):
        ...
        :Parameters:
            trial : array
                a trial whose content is to be refined
        """
        pass
