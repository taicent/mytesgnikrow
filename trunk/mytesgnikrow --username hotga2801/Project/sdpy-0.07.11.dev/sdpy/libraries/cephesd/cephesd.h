#ifndef __SD_CEPHES_DOUBLE_H
#define __SD_CEPHES_DOUBLE_H

/*
 *   This file was automatically generated by version 1.7 of cextract.
 *   Manual editing not recommended, but eventually done by Minh-Tri Pham.
 *
...
extern double MACHEP;       /* 2**-53 */
extern double UFLOWTHRESH;  /* 2**-1022 */
extern double MAXLOG;       /* log(MAXNUM) */
extern double MINLOG;       /* log(2**-1075) */
extern double MAXNUM;       /* 2**1024*(1-MACHEP) */
extern double PI;           /* pi */
extern double PIO2;         /* pi/2 */
extern double PIO4;         /* pi/4 */
extern double SQRT2;        /* sqrt(2) */
extern double SQRTH;        /* sqrt(2)/2 */
extern double LOG2E;        /* 1/log(2) */
extern double SQ2OPI;       /* sqrt( 2/pi ) */
extern double LOGE2;        /* log(2) */
extern double LOGSQ2;       /* log(2)/2 */
extern double THPIO4;       /* 3*pi/4 */
extern double TWOOPI;       /* 2/pi */
extern double INFINITY;     /* 99e999; */
extern double NAN;
...
extern double arcdot( double p[], double q[] ); // return the angle between two 3D vectors
