...
void AdaBoostClassifier::TrainAdaBoost(int rounds,const bool update)
{
	ofstream f;
	int i,j;
	REAL* curresult;
...
void AdaBoostClassifier::TrainLDS(int rounds,const bool update)
{

    TrainAdaBoost(rounds,false);
